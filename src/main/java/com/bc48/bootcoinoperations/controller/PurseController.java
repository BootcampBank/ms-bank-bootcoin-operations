package com.bc48.bootcoinoperations.controller;

import com.bc48.bootcoinoperations.service.PurseService;
...
@Tag(name = "Type change", description = "Manage mainteance of purse")
@CrossOrigin(value = {"*"})
